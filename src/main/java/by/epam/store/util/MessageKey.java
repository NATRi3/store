...
public class MessageKey {
    ...
    public static final String ERROR_MESSAGE_USER_BLOCKED = "message.user_blocked";
    ...
    public static final String SUCCESSFUL_PRODUCT_ADD = "message.successful_product_add";
    public static final String SUCCESSFUL_CHANGE = "message.successful_change";
    public static final String SUCCESSFUL_ACTIVATION = "message.successful_activation";
