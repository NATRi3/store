...
public class DataBaseColumn {
    ...
    public static final String ORDER_PRODUCT_ID_ORDER = "id_order";
    public static final String ORDER_PRODUCT_ID_PRODUCT = "id_product";
    public static final String ORDER_PRODUCT_PRODUCT_AMOUNT = "product_amount";
    public static final String ID_ORDER = "id_orders";
    public static final String ORDER_ID_ACCOUNT = "id_account";
