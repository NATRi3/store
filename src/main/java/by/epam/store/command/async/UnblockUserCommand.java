...
public class UnblockUserCommand implements CommandAsync {
    private final static Logger log = LogManager.getLogger(UnblockUserCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                String messageKey = userService.changeStatus(id, TypeStatus.ACTIVE);
