        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                    <img class="img-thumbnail" width="120" height="120" id="accountImg"
                         alt="${sessionScope.currentUser.imageName}"
                         src="${sessionScope.currentUser.imageName}"/>
                    <div class="file btn btn-lg btn-primary">
                        <fmt:message key="account.change_img" bundle="${text}"/>
                        <form name="uploadForm"
                              action="${pageContext.request.contextPath}/controller?command=upload_image&image_command=user&ctoken=${sessionScope.stoken}"
                            ...
                            <div class='modal-content'>
                                <form method="post" action="${pageContext.request.contextPath}/controller">
                                    <div class='modal-header'>
                                        <h5 class='modal-title'><fmt:message key='admin.menu_add_product'
                                                                             bundle='${text}'/></h5>
                                    </div>
                                    <div class='modal-body'>
                                        <input type='hidden' name='command' value='create_admin'>
                                        <input type='hidden' name='ctoken' value='${sessionScope.stoken}'/>
                                        <input maxlength="45" data-toggle="tooltip"
                                               title="<fmt:message key="toggle.password" bundle="${text}"/>"
                                    ...
                                    <button type='button' class='btn btn-secondary' data-dismiss='modal'><fmt:message
                                            key='button.close' bundle='${text}'/></button>
                                    <input type='submit' value='<fmt:message key='button.save' bundle='${text}'/>'
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#wallet" role="tab"
            ...
            <form method="get" action="${pageContext.request.contextPath}/controller" class="col-md-2">
                ...
                <input type="submit" class="profile-edit-btn"
                       value="<fmt:message key="header.logout" bundle="${text}"/>"/>
            </form>
            <br>
        </div>
    </div>
