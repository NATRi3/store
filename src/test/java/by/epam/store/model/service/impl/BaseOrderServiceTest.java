...
import by.epam.store.model.dao.impl.BaseOrderDao;
...
public class BaseOrderServiceTest {
    ...
    public void testCreateOrder() {
        ...
        User user = new User();
        user.setId(1);
        params.put(RequestParameterAndAttribute.PHONE,new String[]{"1"});
        params.put(RequestParameterAndAttribute.ADDRESS,new String[]{"1"});
        try {
