...
public class BaseProductServiceTest {
    ...
    public void testSaveProduct() {
        ...
        parameters.put(RequestParameterAndAttribute.PRICE_PRODUCT,new String[]{"12.0"});
        parameters.put(RequestParameterAndAttribute.NAME_PRODUCT,new String[]{""});
        parameters.put(RequestParameterAndAttribute.INFO_PRODUCT,new String[]{""});
        try {
