...
import by.epam.store.model.dao.impl.BaseNewsDao;
...
public class BaseNewsServiceTest {
    ...
    public void testCreateNews() {
        ...
        params.put(RequestParameterAndAttribute.NEWS_TITLE,new String[]{""});
        params.put(RequestParameterAndAttribute.NEWS_INFO,new String[]{""});
        try {
    ...
    public void testChangeNews() {
        Map<String,String[]> params = new HashMap<>();
        params.put(RequestParameterAndAttribute.ID_NEWS,new String[]{"1"});
        params.put(RequestParameterAndAttribute.NEWS_TITLE,new String[]{""});
        params.put(RequestParameterAndAttribute.NEWS_INFO,new String[]{""});
        try {
