...
public class BaseUserServiceTest {
    ...
    public void setUp() {
        ...
        password = "123";
        params = new HashMap<>();
        params.put(RequestParameterAndAttribute.PASSWORD, password);
        params.put(RequestParameterAndAttribute.CHANGE_PASSWORD_OLD, password);
        params.put(RequestParameterAndAttribute.ID_USER, String.valueOf(expected.getId()));
        params.put(RequestParameterAndAttribute.EMAIL,expected.getEmail());
    }
    ...
    public void testChangeStatusFromTo() throws ServiceException, DaoException {
        ...
        assertEquals(
                ...
                MessageKey.SUCCESSFUL_CHANGE_STATUS
        );
    }
    ...
    public void testChangeImage() throws DaoException, ServiceException {
        ...
        assertEquals(
                ...
                MessageKey.SUCCESSFUL_CHANGE_IMAGE
        );
    }
}